...
- 🪞 [ditto](https://github.com/ohad6k/ditto) - Loads your personal profile, mined from your local Claude Code/Codex/OpenCode logs, so your agent works like you. Run with `uvx ditto-cli mcp`.
